...
public enum ParticleEffect
{
  EXPLOSION_NORMAL(
    ...
    "dragonbreath", 42, -1, new ParticleProperty[] { ParticleProperty.DIRECTIONAL }),  END_ROD("endrod", 43, -1, new ParticleProperty[] { ParticleProperty.DIRECTIONAL }),  DAMAGE("damageindicator", 44, -1, new ParticleProperty[] { ParticleProperty.DIRECTIONAL });
  ...
  public void display(Player p, float offsetX, float offsetY, float offsetZ, float speed, int amount, Location center, double range)
    throws ParticleEffect.ParticleVersionException, ParticleEffect.ParticleDataException, IllegalArgumentException
  {
    ...
    new ParticlePacket(this, offsetX, offsetY, offsetZ, speed, amount, range > 256.0D, null).sendTo(center, range, p);
  }
  ...
  public static final class ParticlePacket
  {
    ...
    public void sendTo(Location center, double range, Player from)
      throws IllegalArgumentException
    {
      if (range < 1.0D) {
        throw new IllegalArgumentException("The range is lower than 1");
