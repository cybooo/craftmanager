...
public class DeathListener implements Listener {
    ...
    private void broadcastDeath(Player p, EntityDamageEvent.DamageCause cause, EntityDeathEvent e, Entity killer) {
        ...
        if (cause.equals(EntityDamageEvent.DamageCause.CONTACT)) {
            for (Player pl : Main.getInstance().death_messages) {
                pl.sendMessage(Main.getInstance().getConfig().getStringList("d_msgs.cactus").get(r.nextInt(Main.getInstance().getConfig().getStringList("d_msgs.cactus").size()))
                        .replace("%player%", p.getName()));
            }
        } else if (cause.equals(EntityDamageEvent.DamageCause.DROWNING)) {
            for (Player pl : Main.getInstance().death_messages) {
                pl.sendMessage(Main.getInstance().getConfig().getStringList("d_msgs.drown").get(r.nextInt(Main.getInstance().getConfig().getStringList("d_msgs.drown").size()))
                        .replace("%player%", p.getName()));
            }
...
//                                .replace("%weapon%", p2.getInventory().getItemInMainHand().getItemMeta().getDisplayName()));
                    ...
                    for (Player pl : Main.getInstance().death_messages) {
                        pl.sendMessage(Main.getInstance().getConfig().getStringList("d_msgs.player").get(r.nextInt(Main.getInstance().getConfig().getStringList("d_msgs.player").size()))
                                .replace("%player%", p.getName())
                                .replace("%attacker%", p2.getName()));
                    }
                }
            ...
            for (Player pl : Main.getInstance().death_messages) {
                pl.sendMessage(Main.getInstance().getConfig().getStringList("d_msgs.creeper").get(r.nextInt(Main.getInstance().getConfig().getStringList("d_msgs.creeper").size()))
                        .replace("%player%", p.getName()));
            }
        } else if (cause.equals(EntityDamageEvent.DamageCause.BLOCK_EXPLOSION)) {
            for (Player pl : Main.getInstance().death_messages) {
                pl.sendMessage(Main.getInstance().getConfig().getStringList("d_msgs.tnt").get(r.nextInt(Main.getInstance().getConfig().getStringList("d_msgs.tnt").size()))
                        .replace("%player%", p.getName()));
            }
        } else if (cause.equals(EntityDamageEvent.DamageCause.FALL)) {
            for (Player pl : Main.getInstance().death_messages) {
                pl.sendMessage(Main.getInstance().getConfig().getStringList("d_msgs.fall").get(r.nextInt(Main.getInstance().getConfig().getStringList("d_msgs.fall").size()))
                        .replace("%player%", p.getName()));
            }
        } else if (cause.equals(EntityDamageEvent.DamageCause.FALLING_BLOCK)) {
            for (Player pl : Main.getInstance().death_messages) {
                pl.sendMessage(Main.getInstance().getConfig().getStringList("d_msgs.falling_block").get(r.nextInt(Main.getInstance().getConfig().getStringList("d_msgs.falling_block").size()))
                        .replace("%player%", p.getName()));
            }
            ...
            for (Player pl : Main.getInstance().death_messages) {
                pl.sendMessage(Main.getInstance().getConfig().getStringList("d_msgs.fire").get(r.nextInt(Main.getInstance().getConfig().getStringList("d_msgs.fire").size()))
                        .replace("%player%", p.getName()));
            }
        } else if (cause.equals(EntityDamageEvent.DamageCause.LAVA)) {
            for (Player pl : Main.getInstance().death_messages) {
                pl.sendMessage(Main.getInstance().getConfig().getStringList("d_msgs.lava").get(r.nextInt(Main.getInstance().getConfig().getStringList("d_msgs.lava").size()))
                        .replace("%player%", p.getName()));
            }
        } else if (cause.equals(EntityDamageEvent.DamageCause.LIGHTNING)) {
            for (Player pl : Main.getInstance().death_messages) {
                pl.sendMessage(Main.getInstance().getConfig().getStringList("d_msgs.lightning").get(r.nextInt(Main.getInstance().getConfig().getStringList("d_msgs.lightning").size()))
                        .replace("%player%", p.getName()));
            }
        } else if (cause.equals(EntityDamageEvent.DamageCause.MAGIC)) {
            for (Player pl : Main.getInstance().death_messages) {
                pl.sendMessage(Main.getInstance().getConfig().getStringList("d_msgs.magic").get(r.nextInt(Main.getInstance().getConfig().getStringList("d_msgs.magic").size()))
                        .replace("%player%", p.getName()));
            }
        } else if (cause.equals(EntityDamageEvent.DamageCause.PROJECTILE)) {
            for (Player pl : Main.getInstance().death_messages) {
                pl.sendMessage(Main.getInstance().getConfig().getStringList("d_msgs.projectile").get(r.nextInt(Main.getInstance().getConfig().getStringList("d_msgs.projectile").size()))
                        .replace("%player%", p.getName()));
            }
        } else if (cause.equals(EntityDamageEvent.DamageCause.SUFFOCATION)) {
            for (Player pl : Main.getInstance().death_messages) {
                pl.sendMessage(Main.getInstance().getConfig().getStringList("d_msgs.suffocation").get(r.nextInt(Main.getInstance().getConfig().getStringList("d_msgs.suffocation").size()))
                        .replace("%player%", p.getName()));
            }
        } else if (cause.equals(EntityDamageEvent.DamageCause.THORNS)) {
            for (Player pl : Main.getInstance().death_messages) {
                pl.sendMessage(Main.getInstance().getConfig().getStringList("d_msgs.thorns").get(r.nextInt(Main.getInstance().getConfig().getStringList("d_msgs.thorns").size()))
                        .replace("%player%", p.getName()));
            }
        } else if (cause.equals(EntityDamageEvent.DamageCause.VOID)) {
            for (Player pl : Main.getInstance().death_messages) {
                pl.sendMessage(Main.getInstance().getConfig().getStringList("d_msgs.void").get(r.nextInt(Main.getInstance().getConfig().getStringList("d_msgs.void").size()))
                        .replace("%player%", p.getName()));
            }
        } else if (cause.equals(EntityDamageEvent.DamageCause.WITHER)) {
            for (Player pl : Main.getInstance().death_messages) {
                pl.sendMessage(Main.getInstance().getConfig().getStringList("d_msgs.wither").get(r.nextInt(Main.getInstance().getConfig().getStringList("d_msgs.wither").size()))
                        .replace("%player%", p.getName()));
            }
        } else if (cause.equals(EntityDamageEvent.DamageCause.DRAGON_BREATH)) {
            for (Player pl : Main.getInstance().death_messages) {
                pl.sendMessage(Main.getInstance().getConfig().getStringList("d_msgs.dragon_breath").get(r.nextInt(Main.getInstance().getConfig().getStringList("d_msgs.dragon_breath").size()))
                        .replace("%player%", p.getName()));
            }
        } else if (cause.equals(EntityDamageEvent.DamageCause.STARVATION)) {
            for (Player pl : Main.getInstance().death_messages) {
                pl.sendMessage(Main.getInstance().getConfig().getStringList("d_msgs.starvation").get(r.nextInt(Main.getInstance().getConfig().getStringList("d_msgs.starvation").size()))
                        .replace("%player%", p.getName()));
            }
        } else {
            for (Player pl : Main.getInstance().death_messages) {
                pl.sendMessage(Main.getInstance().getConfig().getStringList("d_msgs.unknown").get(r.nextInt(Main.getInstance().getConfig().getStringList("d_msgs.unknown").size()))
                        .replace("%player%", p.getName()));
            }
        }
    }
