...
public class ParticlesMainGUI implements InventoryProvider {
    ...
    public void init(Player player, InventoryContents contents) {
        ...
        contents.fillRow(4, ClickableItem.of(new ItemBuilder(Material.STAINED_GLASS_PANE).setDurability((short)9).setName("§a ").build(), item -> {}));
        ...
        contents.set(4, 4, ClickableItem.of(new ItemBuilder(Material.BARRIER).setName("§c§lDeaktivovat").build(), e -> {
