...
public class TextComponentBuilder {
    ...
    public TextComponentBuilder(String message) {
        this.component = new TextComponentMerger(TextComponent.fromLegacyText(ChatColor.translateAlternateColorCodes('&', message))).output(false);
    }

    public TextComponentBuilder(String message, boolean centered) {
        this.component = new TextComponentMerger(TextComponent.fromLegacyText(centered ? StringUtils.getCenteredMessage(ChatColor.translateAlternateColorCodes('&', message)) : ChatColor.translateAlternateColorCodes('&', message))).output(false);
    }
